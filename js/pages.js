...
function renderDashboardPage() {
  ...
  el.innerHTML = `
    <div class="page-header">
      <div>
        <h1 class="page-title">Dashboard <span style="font-size:10px;font-weight:400;color:var(--text-muted);background:var(--bg-secondary);padding:2px 6px;border-radius:4px;vertical-align:middle;margin-left:8px">v1.2.7</span></h1>
